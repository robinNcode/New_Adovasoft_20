...
<body>
            ...
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="/home">
                     <img class="logo-default" src="/images/logo.jpg" alt="logo" />
                  </a>
               </div>
               <div class="collapse navbar-collapse">
                  <div class="nav navbar-nav navbar-right">
                     <ul class="nav navbar-nav">
                        ...
                        <!-- ..................About US............................. -->
                        <li class="dropdown">
                           <a href="/about_us" class="dropdown-toggle" data-toggle="dropdown" role="button">About us <span class="caret"></span></a>
                           <ul class="dropdown-menu multi-level">
                              ...
                              <li class="dropdown dropdown-submenu">
                                 <a href="/technology" class="" data-toggle="">Technology Used</a>
                              </li>
                              <li class="dropdown dropdown-submenu">
                                 <a href="/terms_and_conditions" class="" data-toggle="">Terms and conditions</a>
                              </li>
                              <li class="dropdown dropdown-submenu">
                                 <a href="/energy_saving_websites" class="" data-toggle="">Energy Saving Websites</a>
                              </li>
                              <li class="dropdown dropdown-submenu">
                        ...
                        <!-- .......................Services........................... -->
                        <li class="dropdown">
                           <a href="/packages" class="dropdown-toggle" data-toggle="dropdown" role="button">Services <span class="caret"></span></a>
                           <ul class="dropdown-menu multi-level">
                              <li class="dropdown dropdown-submenu">
                                 <a href="/website_packages" class="dropdown-toggle" data-toggle="dropdown">Website Packages</a>
                                 <ul class="dropdown-menu">
                        ...
                        <li>
                           ...
                           <form action="index.php?page=search" method="POST" class="searchform form-control" autocomplete="off" />
                           <input type="text" name="searchword" class="searchword" value="" placeholder="Search" required />
                           <span><input type="submit" name="search" class="searchsubmit" value="GO" /></span>
                           </form>
   ...
   <div class="container" id='sud4'>
      <div class="row">
         <div class="col-md-6">
            <a href="http://info.flagcounter.com/1e30"><img src="http://s11.flagcounter.com/count/1e30/bg_FFFFFF/txt_000000/border_ffffff/columns_4/maxflags_72/viewers_1/labels_1/pageviews_1/flags_0/" alt="Flag Counter" border="0">
            </a>
         </div>
   ...
   <i class="scroll-top scroll-top-mobile show fa fa-sort-asc bg-success"></i>
   <footer class="footer-base">
      <div class="content">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6 footer-left text-left">
                  <p>Pearl Street 07, Shamoli, Dhaka.</p>
                  <div class="tag-row">
                     <span>support@adovasoft.com</span>
                     <span>+02 3205550678</span>
                  </div>
               </div>
               <div class="col-md-3 footer-left text-right text-left-sm">
                  <div class="btn-group social-group btn-group-icons">
                     <a target="_blank" href="https://www.facebook.com/adovasoft" data-social="share-facebook">
         ...
         <div class="row copy-row">
            <div class="col-md-12 copy-text">
               Copyright &#169; <a href="http://adovasoft.com" target="_blank">ADOVA SOFT</a> All rights reserved.

               <span>Developed by <a href="http://adovasoft.com/" target="_blank">Adova Soft</a></span>
            </div>
         </div>
      </div>
      ...
      <!-- OLD website scripts start fronm here -->
