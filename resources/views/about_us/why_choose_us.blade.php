...
<html  lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		<title>Why Choose Us ? - About us - ADOVA SOFT</title>
		...
		<meta name="Description" content="• Adova Soft is the most convenient choice for database solutions in Bangladesh. We provide customized databases meeting everyone’s demand.

• Adova Soft provides database services of various range so it is affordable to all.

• Adova Soft provide online, offline and hybrid database solutions according to your needs and demands.

• The online and hybrid database of Adova Soft are hosted in remote servers which are situated in USA which guarantees data safety.

• Proper backup protocol is provided will the offline databases of Adova Soft which prevent data loss.

• Our Hybrid technology database provides both multiuser online access like online database and speed of offline database in a single package.

• Adova Soft provides post development services like maintenance, troubleshooting, updating and renovating if necessary.
 - About us - Adova Soft is a website design company in bangladesh who also provides software development,e-commerce,effective SEO services,domain and hosting in bangladesh."/>
...
<a href='https://www.facebook.com/adovasoft' target='_blank'><img src='images/facebook.png'/></a><form action="index.php?page=search" method="POST" class="searchform" autocomplete="off"/>
	<input type="text" name="searchword"  class="searchword"  value="" placeholder="Search" required/><input type="submit" name="search"  class="searchsubmit" value="GO"/>
			...
			<div id="highlightbg">
					<div id="highlight">
						<div id='sidemenu'><br/><b>About us</b><a href='index.php?page=about_us&&data_id=138'>Specialties of Adova Soft</a><a href='index.php?page=about_us&&data_id=172'>Why Choose Us ?</a><a href='index.php?page=about_us&&data_id=139'>Designing Preferences</a><a href='index.php?page=about_us&&data_id=214'>Information technology in Bangladesh</a><a href='index.php?page=about_us&&data_id=152'>Website Hosting in Bangladesh</a><a href='index.php?page=about_us&&data_id=140'>Our Dream, Mission and Vision</a><a href='index.php?page=about_us&&data_id=174'>Database Solution in Bangladesh</a><a href='index.php?page=about_us&&data_id=173'>Our Database Solutions</a><a href='index.php?page=about_us&&data_id=175'>Technology Used</a><a href='index.php?page=about_us&&data_id=177'>Terms and conditions</a><a href='index.php?page=about_us&&data_id=213'>Energy Saving Websites</a></div><div class='embossed'><h2>Why Choose Us ?</h2><div class='singlebigimg'><a href='index.php?page=largeview&&img_id=465&&data_id=172&&backpage=about_us'><img src='images/db/465.png' alt='Why Choose Us ?'/></a><b><big class='green'>Why Choose Us ?</big></b></div><p>• Adova Soft is the most convenient choice for database solutions in Bangladesh. We provide customized databases meeting everyone’s demand.<br />
<br />
